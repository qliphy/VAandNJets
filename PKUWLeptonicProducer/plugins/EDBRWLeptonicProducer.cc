// -*- C++ -*-
//
// Package:    ExoDiBosonResonances/PKUWLeptonicProducer
// Class:      PKUWLeptonicProducer
// 
/**\class PKUWLeptonicProducer PKUWLeptonicProducer.cc ExoDiBosonResonances/PKUWLeptonicProducer/plugins/PKUWLeptonicProducer.cc
...
class PKUWLeptonicProducer : public edm::EDProducer {
public:
  explicit PKUWLeptonicProducer(const edm::ParameterSet&);
  ~PKUWLeptonicProducer();
...
//
PKUWLeptonicProducer::PKUWLeptonicProducer(const edm::ParameterSet& iConfig):
...
PKUWLeptonicProducer::~PKUWLeptonicProducer()
{
...
void
PKUWLeptonicProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
PKUWLeptonicProducer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
PKUWLeptonicProducer::endJob() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
PKUWLeptonicProducer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
PKUWLeptonicProducer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
PKUWLeptonicProducer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
PKUWLeptonicProducer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
PKUWLeptonicProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
PKUWLeptonicProducer::getNeutrinoP4(const reco::Candidate& met, const reco::Candidate& lep, int lepType){//lepType 0 ele, 1 mu
...
DEFINE_FWK_MODULE(PKUWLeptonicProducer);
