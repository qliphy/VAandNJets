...
process.load("VAplusNJets.PKUGenStudies.genMuons_cff")
process.load("VAplusNJets.PKUGenStudies.genElectrons_cff")
process.load("VAplusNJets.PKUGenStudies.selectLeptonicDecay")
process.load("VAplusNJets.PKUGenStudies.selectHadronicDecay")
...
process.p2 = cms.Path(process.leptonicDecay 
                      ...
                      + process.printTree)
process.load("VAplusNJets.PKUCommon.simulation.RSGravToZZ_kMpl01_M-4500")
#process.load("VAplusNJets.PKUCommon.simulation.DYJetsToLL_HT-600toInf")
